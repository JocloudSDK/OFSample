...
#ifndef __TEST_USE_BIND_H__
#define __TEST_USE_BIND_H__
...
namespace __tiny_bind_impl
{
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4, a5, a6, a7, a8, a9);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4, a5, a6, a7, a8);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4, a5, a6, a7);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4, a5, a6);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4, a5);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3, a4);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2, a3);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1, a2);}
	};
	...
	public:
		...
		virtual R invoke() const { return (pThis->*mfn)(a1);}
	};
	...
	// 静态及全局函数
	//_tiny_bind_data_N，所有_tiny_bind_data_N必须自_tiny_bind_data_base派生
	template <class R, class MFN, 
	class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
	class _tiny_bind_data_static_9 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A9 a9;
	public:
		_tiny_bind_data_static_9(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7, A8 _a8, A9 _a9)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4), a5(_a5), a6(_a6), a7(_a7), a8(_a8), a9(_a9) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4, a5, a6, a7, a8, a9);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
	class _tiny_bind_data_static_8 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A8 a8;
	public:
		_tiny_bind_data_static_8(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7, A8 _a8)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4), a5(_a5), a6(_a6), a7(_a7), a8(_a8) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4, a5, a6, a7, a8);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3, class A4, class A5, class A6, class A7>
	class _tiny_bind_data_static_7 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A7 a7;
	public:
		_tiny_bind_data_static_7(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4), a5(_a5), a6(_a6), a7(_a7) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4, a5, a6, a7);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3, class A4, class A5, class A6>
	class _tiny_bind_data_static_6 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A6 a6;
	public:
		_tiny_bind_data_static_6(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4), a5(_a5), a6(_a6) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4, a5, a6);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3, class A4, class A5>
	class _tiny_bind_data_static_5 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A5 a5;
	public:
		_tiny_bind_data_static_5(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4), a5(_a5) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4, a5);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3, class A4>
	class _tiny_bind_data_static_4 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		...
		A4 a4;
	public:
		_tiny_bind_data_static_4(MFN _mfn, A1 _a1, A2 _a2, A3 _a3, A4 _a4)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3), a4(_a4) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3, a4);}
	};

	template <class R, class MFN, 
	class A1, class A2, class A3>
	class _tiny_bind_data_static_3 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
		A3 a3;
	public:
		_tiny_bind_data_static_3(MFN _mfn, A1 _a1, A2 _a2, A3 _a3)
			: mfn(_mfn), a1(_a1), a2(_a2), a3(_a3) {}
		virtual R invoke() const { return (*mfn)(a1, a2, a3);}
	};

	template <class R, class MFN, 
	class A1, class A2>
	class _tiny_bind_data_static_2 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
		A2 a2;
	public:
		_tiny_bind_data_static_2(MFN _mfn, A1 _a1, A2 _a2)
			: mfn(_mfn), a1(_a1), a2(_a2) {}
		virtual R invoke() const { return (*mfn)(a1, a2);}
	};

	template <class R, class MFN, 
	class A1>
	class _tiny_bind_data_static_1 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
		A1 a1;
	public:
		_tiny_bind_data_static_1(MFN _mfn, A1 _a1)
			: mfn(_mfn), a1(_a1) {}
		virtual R invoke() const { return (*mfn)(a1);}
	};

	template <class R, class MFN>
	class _tiny_bind_data_static_0 : public _tiny_bind_data_base<R>
	{
		MFN mfn;
	public:
		_tiny_bind_data_static_0(MFN _mfn)
			: mfn(_mfn) {}
		virtual R invoke() const {return (*mfn)();}
	};
	...
	class B1, class B2, class B3, class B4, class B5, class B6, class B7, class B8, class B9, 
	class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4,B5,B6,B7,B8,B9), 
		A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7, A8 _a8, A9 _a9)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_9<R, R (*)(B1,B2,B3,B4,B5,B6,B7,B8,B9), 
			A1, A2, A3, A4, A5, A6, A7, A8, A9>(_mfn, _a1, _a2, _a3, _a4, _a5, _a6, _a7, _a8, _a9));
	}

	template <class R,
	class B1, class B2, class B3, class B4, class B5, class B6, class B7, class B8, 
	class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4,B5,B6,B7,B8),
		A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7, A8 _a8)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_8<R, R (*)(B1,B2,B3,B4,B5,B6,B7,B8), 
			A1, A2, A3, A4, A5, A6, A7, A8>(_mfn, _a1, _a2, _a3, _a4, _a5, _a6, _a7, _a8));
	}

	template <class R,
	class B1, class B2, class B3, class B4, class B5, class B6, class B7,  
	class A1, class A2, class A3, class A4, class A5, class A6, class A7> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4,B5,B6,B7),
		A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6, A7 _a7)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_7<R, R (*)(B1,B2,B3,B4,B5,B6,B7), 
			A1, A2, A3, A4, A5, A6, A7>(_mfn, _a1, _a2, _a3, _a4, _a5, _a6, _a7));
	}

	template <class R,
	class B1, class B2, class B3, class B4, class B5, class B6,  
	class A1, class A2, class A3, class A4, class A5, class A6> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4,B5,B6), 
		A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5, A6 _a6)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_6<R, R (*)(B1,B2,B3,B4,B5,B6), 
			A1, A2, A3, A4, A5, A6>(_mfn, _a1, _a2, _a3, _a4, _a5, _a6));
	}

	template <class R,
	class B1, class B2, class B3, class B4, class B5,  
	class A1, class A2, class A3, class A4, class A5> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4,B5),
		A1 _a1, A2 _a2, A3 _a3, A4 _a4, A5 _a5)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_5<R, R (*)(B1,B2,B3,B4,B5), 
			A1, A2, A3, A4, A5>(_mfn, _a1, _a2, _a3, _a4, _a5));
	}

	template <class R, 
	class B1, class B2, class B3, class B4,   
	class A1, class A2, class A3, class A4> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3,B4),
		A1 _a1, A2 _a2, A3 _a3, A4 _a4)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_4<R, R (*)(B1,B2,B3,B4), 
			A1, A2, A3, A4>(_mfn, _a1, _a2, _a3, _a4));
	}

	template <class R,
	class B1, class B2, class B3,   
	class A1, class A2, class A3> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2,B3),
		A1 _a1, A2 _a2, A3 _a3)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_3<R, R (*)(B1,B2,B3), 
			A1, A2, A3>(_mfn, _a1, _a2, _a3));
	}

	template <class R, 
	class B1, class B2,   
	class A1, class A2> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1,B2),
		A1 _a1, A2 _a2)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_2<R, R (*)(B1,B2), 
			A1, A2>(_mfn, _a1, _a2));
	}
	...
	class B1,   
	class A1> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)(B1),
		A1 _a1)
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_1<R, R (*)(B1), 
			A1>(_mfn, _a1));
	}

	template <class R> inline 
		tiny_function0<R> tiny_bind(R (*_mfn)())
	{
		return _tiny_bind_data_ptr<R>(new _tiny_bind_data_static_0<R, R (*)()>(_mfn));
	}
