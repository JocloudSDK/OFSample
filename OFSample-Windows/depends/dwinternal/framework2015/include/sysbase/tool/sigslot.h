...
#ifndef SIGSLOT_FATAL_ERROR
#	ifdef	_DEBUG 
#		define SIGSLOT_FATAL_ERROR(err) do { ::MessageBoxA(NULL, err, "internal beta error", MB_OK|MB_SERVICE_NOTIFICATION); (*(int*)(0)) = 0; } while(0)
#	else
#		define SIGSLOT_FATAL_ERROR(err) do { return; } while(0)
#	endif
#endif
...
namespace sigslot {
	...
	template<class mt_policy>
		...
		class DWBASE_EXPORTS has_slots
	{
		private:
			class DWBASE_EXPORTS slot_wrapper
			{
				public:
		...
		public:
			class DWBASE_EXPORTS slot_holder
			{
				public:
	...
	class DWBASE_EXPORTS _connection_base
	{
		public:
			_connection_base();
			...
			class DWBASE_EXPORTS connection_holder
			{
				public:
	...
	public:
		...
		template<class dest_type>
			void connect(dest_type* pclass, void (dest_type::*pmemfun)())
			{
				...
				{
					SIGSLOT_FATAL_ERROR("duplicate connection, check your fxxking code!");
				}
